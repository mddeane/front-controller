...
public class EmployeeServiceTests {
	...
	public void setup() {
		...
		eserv = new EmployeeService(mockdao); // we pass the mock dao into the service laye object so it uses out imposter obj 
	}
	...
	public void testConfirmLogin_fail() {
		...
		// test that when you pass in a username and password combo to the confirmLogin() method
		// it returns NULL if no user within the "fake' database has that combo
		...
		Employee actual = eserv.confirmLogin("hawkeye", "hhh");
